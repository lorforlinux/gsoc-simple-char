 ...
 */
static int gsoc_dev_open(struct inode *inodep, struct file *filep){
   numberOpens++;
...
static ssize_t gsoc_dev_read(struct file *filep, char *buffer, size_t len, loff_t *offset){
...
static ssize_t gsoc_dev_write(struct file *filep, const char *buffer, size_t len, loff_t *offset){
 ...
 *  @param filep A pointer to a file object (defined in linux/fs.h)
 */
static int gsoc_dev_release(struct inode *inodep, struct file *filep){
...
static struct file_operations fops =
{
   .open = gsoc_dev_open,
   .read = gsoc_dev_read,
   .write = gsoc_dev_write,
   .release = gsoc_dev_release,
};
